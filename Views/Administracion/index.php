            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        ...
                        <label for="ruc"><i class="fas fa-id-card"></i> Nit</label>
                        <input id="ruc" class="form-control" type="number" name="ruc" placeholder="Nit" value="<?php echo $data['empresa']['ruc'] ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group mb-3">
                    <label for="nombre"><i class="fas fa-list"></i> Nombre del gimnasio</label>
                ...
                <div class="col-md-2">
                    <div class="form-group mb-3">
                    <label for="limite"><i class="fas fa-home"></i> Nro Local</label>
                        <input id="limite" class="form-control" type="text" name="limite" placeholder="Nro" value="<?php echo $data['empresa']['limite'] ?>" required>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input id="imagen" class="form-control" type="file" name="imagen"><br>
                        <img class="img-thumbnail" src="<?php echo base_url . 'Assets/images/logo.png'; ?>" alt="LOGO-PNG" width="150">
                    </div>
                </div>
            </div>
                <div class="d-grid gap-2 my-3">
                    <button class="btn btn-primary" type="submit" id="btnAccion">Guardar</button>
                </div>
        </form>
    </div>
</div>
