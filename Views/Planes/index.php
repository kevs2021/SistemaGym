            ...
            <form id="formulario" onsubmit="registrarPlan(event);" autocomplete="off">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="precio_plan">Precio membresia *</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                <label for="condicion">Duración de la membresia (días) *</label>
                                <input type="number" class="form-control" id="condicion" name="condicion" placeholder="Ingrese la duración en días" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                ...
                <div class="modal-footer">
                    <button class="btn btn-primary" type="submit" id="btnAccion" style="background-color: #04B76B; border:#04B76B;">Registrar</button>
