...
class Entrenador extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $data[$i]['editar'] = '<button class="btn btn-primary" type="button" onclick="btnEditarEnt(' . $data[$i]['id'] . ');"><i class="fas fa-edit"></i></button>';
            $data[$i]['eliminar'] = '<button class="btn btn-danger" type="button" onclick="btnEliminarEnt(' . $data[$i]['id'] . ');"><i class="fas fa-trash-alt"></i></button>';
        }
